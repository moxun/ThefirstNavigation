...
public class CommentFragment extends BaseFragment<NotifyMvp.NotifyView, NotifyPresenter<NotifyMvp.NotifyView>> implements NotifyMvp.NotifyView {
    @BindView(R.id.recy_more)
    RecyclerView mRecyMore;
    private ArrayList<ListNoiftyBean.DataBean> mDataBeans = new ArrayList<>();
    private String mType;
    private CommentNotiftAdapter mSystemAdapter;
    ...
    public void showNotify(ListNoiftyBean listNoiftyBean) {
        ...
        mSystemAdapter = new CommentNotiftAdapter(mDataBeans, context);
