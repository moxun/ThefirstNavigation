...
public class CommentNotiftAdapter extends RecyclerView.Adapter {
    public ArrayList<ListNoiftyBean.DataBean> mList;
    private final Context context;

    public CommentNotiftAdapter(ArrayList<ListNoiftyBean.DataBean> dataBeans, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_usermessage_comment, parent, false);
